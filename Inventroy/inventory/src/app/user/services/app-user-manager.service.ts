...
export class AppUserManagerService {
  ...
  public forgetPassword(model: any): Observable<any>{
    return this.httpClient.post<any>(this.url +"forgetPassword" , model, headerOption);
  }
  public resetPassword(model: PasswordReset): Observable<PasswordReset>{
    return this.httpClient.post<PasswordReset>(this.url +"resetPassword" , model, headerOption);
  }
